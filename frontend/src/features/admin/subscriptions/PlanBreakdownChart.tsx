...
export function PlanBreakdownChart({ subscriptions }: { subscriptions: AdminSubscription[] }) {
  ...
  if (data.length === 0) {
    return <div className="rounded-lg border border-slate-200 bg-white p-4 text-sm text-slate-500">No data.</div>;
  }
