...
import { resetPasswordSchema, type ResetPasswordDto } from '@/lib/validations/auth.schema';
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div>
        ...
        <input id="token" type="text" autoComplete="one-time-code" className={inputClass + ' font-mono'} {...register('token')} />
